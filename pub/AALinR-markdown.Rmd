...
The AALinR [@Todorov:2020] largely following the catastrophe modeling practices computes the Average Annualized Loss using Riemann numerical integration midpoint method [@RietmannMethod:2020]. 
...
- *LA6* a suite of return period hurricane losses at Census Tract (CT) level for the six Louisiana parishes around New Orleans, namely: Saint Bernard, Saint Charles, Saint Tammany, Jefferson, Plaquemines, and New Orleans parishes (352 CTs, 2,816 CT RPs).
